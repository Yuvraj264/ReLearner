...
import { LayoutDashboard, Target, RefreshCw, Bell, UserCircle, Zap, Activity, Brain, ChevronLeft, ChevronRight, Flame, Crosshair } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <nav className={`space-y-2 flex-1 overflow-x-hidden ${isCollapsed ? 'flex flex-col items-center' : ''}`}>
        ...
        <SidebarNavItem to="/learner/interview" label="Interview Mode" icon={Crosshair} isCollapsed={isCollapsed} />
